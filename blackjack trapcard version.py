...
troll_img = simplegui.load_image("http://forums.irowiki.org/attachment.php?attachmentid=3438&stc=1&d=1282862846")
...
def draw(canvas):
    ...
    if troll == True:
        canvas.draw_image(troll_img, (300,225), (485,450), (300,300), (600,600))
...
frame.add_button("Trap Card", trap, 200)
